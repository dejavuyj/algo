...
public class Code241_different_ways_to_add_parentheses {
    ...
    public static void main(String[] args) {
        Code241_different_ways_to_add_parentheses c = new Code241_different_ways_to_add_parentheses();
        String expression = "2-1-1";
        List<Integer> ansList = c.diffWaysToCompute(expression);
